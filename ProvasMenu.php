	...
	<div class="row" id="centro">
		...
		<div class="col-md-6">
			<div class="rectangle">
					...
					<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="botaoFuncProf" formaction="CadastroProva2.php?titulo=<?php $titulo?>&qntPerg=<?php $qntPerg?>&inicio=<?php $inicio?>&fim=<?php $fim?>">
					Editar Prova
					</button>
					</br>
