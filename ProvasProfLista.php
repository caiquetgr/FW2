	...
	<?php
		...
		//Cabeçalho
			...
			while($registro = mysql_fetch_object($resultado)){
				...
				if( strcmp($registro->cpfProfessor, $cpfProfessor) == 0 ){	
			...
			echo "<div class='row' id='cor$cor'>";
				 ...
				 if(strtotime($hoje) > strtotime($dataFimTestada)){
				 		echo "<span style='color: black; font-weight: bold' id='disponibilidade' >Fechada</span>";
				 		$botao = true;
				 }else if(strtotime($hoje) <= strtotime($dataFimTestada) and strtotime($hoje) >= strtotime($dataIniTestada)){
				 		echo "<span style='color: black; font-weight: bold' id='disponibilidade' >Aberta</span>";
				 		$botao = true;	
				 } else {
						echo "<span style='color: black; font-weight: bold' id='disponibilidade' >Aguardando</span>";						
						$botao = true;
				 }
